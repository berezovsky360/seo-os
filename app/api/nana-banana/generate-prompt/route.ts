...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await module.executeAction('generate_image_prompt', { site_id, post_id }, context)

    return NextResponse.json(result)
  } catch (error) {
    console.error('[API] nana-banana/generate-prompt error:', error)
